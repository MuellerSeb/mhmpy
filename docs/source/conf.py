...
# -*- coding: utf-8 -*-
#
# mhmpy documentation build configuration file, created by
...
from mhmpy import __version__ as ver
...
man_pages = [
    (master_doc, "mhmpy", "mhmpy Documentation", [author], 1)
]
